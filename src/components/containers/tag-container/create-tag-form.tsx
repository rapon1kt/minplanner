      ...
      <div className="space-y-4 rounded-sm border border-neutral-800 bg-neutral-900/20 p-4">
        <div>
          ...
          <p className="font-barlow text-sm text-neutral-500">
            Use tags to group tasks by context, project, energy, or anything
            your workflow needs.
          </p>
        </div>
        <form action={formAction} className="grid gap-3 lg:grid-cols-12">
          ...
          <div className="flex flex-col gap-1 lg:col-span-2">
            ...
            <div className="flex justify-center sm:justify-start items-center gap-2 rounded-sm border border-neutral-800 bg-neutral-900 px-2 py-1">
              <input
                id="color"
                name="color"
                type="color"
                ...
                className="sm:h-7 sm:w-7 cursor-pointer bg-transparent"
              />
